...
//
// import '../screens/booking/booking_menu.dart';
...
//   final _buildBody = const <Widget>[BookingMenu(), HomeMenu(), ProfileMenu()];
//
//   late List<BottomNavigationBarItem> _bottomList = <BottomNavigationBarItem>[];
//
//   final menuItemlist = const <MenuItem>[
//     MenuItem(Icons.search, 'Cautati'),
//     MenuItem(Icons.calendar_month, 'Rezervari'),
//     MenuItem(Icons.person, 'Profilul meu'),
//   ];
//
...
//         break;
//       case 1:
//         if (reservationKey.currentState != null &&
//             reservationKey.currentState!.canPop()) {
//           reservationKey.currentState!.pop();
//           exitingApp = false;
//         }
//         break;
//       case 2:
...
//         return;
//       case 1:
//         if (reservationKey.currentState!.canPop()) {
//           reservationKey.currentState!.popUntil((route) => route.isFirst);
//         }
//         return;
//       case 2:
